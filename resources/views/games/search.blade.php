...
<head>
    ...
    <title>Buscar Jogos - GameStore</title>
    ...
    <meta name="description" content="Buscar jogos na GameStore">
...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
                <h2 class="text-xl font-bold mb-4">Sugestões de Busca</h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    @foreach($suggestions as $suggestion)
                        <a 
                            href="{{ route('games.search', ['q' => $suggestion]) }}"
    ...
    <script>
        ...
        document.getElementById('load-more')?.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch(`/api/games?search=${searchQuery}&page=${currentPage + 1}`);
                ...
                if (games.length > 0) {
                    ...
                    this.textContent = 'Não há mais resultados';
                    this.disabled = true;
                }
            } catch (error) {
